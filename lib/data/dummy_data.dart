...
final List<ShoeModel> availableShoe = [
  ShoeModel(
    ...
    model: "AIR-MAX",
    price: 130.00,
    imgAdress: "assets/images/c1.png",
  ...
  ShoeModel(
    ...
    price: 190.00,
    imgAdress: "assets/images/c2.png",
  ...
  ShoeModel(
    ...
    model: "ZOOM",
    price: 160.00,
    imgAdress: "assets/images/c3.png",
  ...
  ShoeModel(
    ...
    price: 150.00,
    imgAdress: "assets/images/c5.png",
  ...
  ShoeModel(
    ...
    model: "AIR-FORCE",
    price: 150.00,
    imgAdress: "assets/images/cs4.png",
    modelColor: const Color(0xff37376B),
  ),
  ShoeModel(
    name: "NIKE",
    model: "ZOOM",
    price: 115.00,
    imgAdress: "assets/images/c6.png",
  ...
  ShoeModel(
    ...
    model: "AIR-JORDAN LOW",
    price: 150.00,
    imgAdress: "assets/images/c7.png",
  ...
  ShoeModel(
    ...
    model: "AIR-JORDAN LOW",
    price: 150.00,
    imgAdress: "assets/images/c8.png",
  ...
  ShoeModel(
    ...
    model: "AIR-FORCE",
    price: 150.00,
    imgAdress: "assets/images/cs9.png",
    modelColor: const Color(0xffE2E3E5),
  ),
  ShoeModel(
    name: "NIKE",
    model: "AIR-FORCE",
    price: 150.00,
    imgAdress: "assets/images/cs10.png",
    modelColor: const Color(0xffE2E3E5),
  ),
];
...
final List<ShoeModel> news = [
  ShoeModel(
    name: "NIKE",
    model: "AIR-FORCE",
    price: 130.00,
    imgAdress: "assets/images/cs1.png",
    modelColor: const Color(0xffDE0106),
  ),
  ShoeModel(
    name: "NIKE",
    model: "AIR-FOCE",
    price: 190.00,
    imgAdress: "assets/images/cs2.png",
    modelColor: const Color(0xff3f7943),
  ),
  ShoeModel(
    name: "NIKE",
    model: "ZOOM",
    price: 160.00,
    imgAdress: "assets/images/cs3.png",
    modelColor: const Color(0xffE66863),
  ),
  ShoeModel(
    name: "NIKE",
    model: "AIR-FORCE",
    price: 150.00,
    imgAdress: "assets/images/cs5.png",
    modelColor: const Color(0xff37376B),
  ),
  ShoeModel(
    name: "NIKE",
    model: "AIR-FORCE",
    price: 115.00,
    imgAdress: "assets/images/cs6.png",
    modelColor: const Color(0xffE4E3E8),
  ),
  ShoeModel(
    name: "NIKE",
    model: "AIR-FORCE",
    price: 150.00,
    imgAdress: "assets/images/cs7.png",
    modelColor: const Color(0xffD68043),
  ),
  ShoeModel(
    name: "NIKE",
    model: "AIR-FORCE",
    price: 150.00,
    imgAdress: "assets/images/cs8.png",
    modelColor: const Color(0xffE2E3E5),
  ),
];
